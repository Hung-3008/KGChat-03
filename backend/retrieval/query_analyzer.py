...
class QueryIntent(Enum):
    ...
    GREETING = "greeting"
    HEALTHCARE_RELATED = "healthcare_related"
...
async def analyze_query(
    ...
    if client:
        try:
            ...
            2. HEALTHCARE_RELATED - Any query about medical symptoms, conditions, treatment, management, medications, diagnostics, lifestyle recommendations, etc.
            ...
            Respond with ONLY the category name, nothing else. For example: 'HEALTHCARE_RELATED'
            ...
            elif "HEALTHCARE" in intent_text or "MEDICAL" in intent_text or "HEALTH" in intent_text:
                intent = QueryIntent.HEALTHCARE_RELATED
    ...
    # Check for healthcare-related intent
    healthcare_keywords = [
        "health", "medical", "symptom", "diagnose", "treatment", "therapy",
        "medicine", "prescription", "doctor", "nurse", "clinic", "hospital",
        "cardiac", "heart", "hypertension", "blood pressure", "cholesterol",
        "asthma", "allergy", "cancer", "mental health", "depression",
        "anxiety", "infection", "antibiotic", "vaccine", "immunization",
        "surgery", "rehabilitation", "diet", "nutrition", "exercise",
        "blood sugar", "glucose", "insulin", "a1c", "metformin",
        "hyperglycemia", "hypoglycemia", "diabetes", "glycemic"
    ]
    if any(keyword in query_lower for keyword in healthcare_keywords):
        return QueryIntent.HEALTHCARE_RELATED
